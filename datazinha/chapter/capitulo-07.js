...
${yellow('<MenorVagabundo>')}Eu só tava testando a campainha pra ver se ainda
funcionava. Que cheiro é esse? Você fez panqueca!
...
dispensa e pega alguns ingredientes. E volta com mais duas
pilhas de panquecas.
...
${yellow('<AmareloVagabundo>')}Pus não, não, se alguém colocou algo, não foi eu
esse alguém.
...
${yellow('<Narração>')}Amarelo avista Menor na cozinha pegando um frango
do armazenador frio.
...
${yellow('<MenorVagabundo>')}Nada, é aquela pirata lá dos heróis sendo caçado
por uns gringos.
${yellow('<AmareloVagabundo>')}Ah, sim. Sei qual é, achei que você tava dizeno
daquela que tão falando que vai sair, mas não sei se isso é verdade
também porque ninguém pode fazer nada que a Ditadora não goste.
${green('<' + heroName + '>')}Vocês dois estão fazendo uma coisa errada e eu não quero
nenhum problema por aqui. Nenhum mesmo. A qualquer momento pode
chegar aqui um GADO.
${yellow('<Narração>')}Amarelo e Menor que até agora não prestavam atenção
ao ${heroName}, param de assistir, arregalam os olhos
e correm se escondendo.
...
${yellow('<PernaVagabundo>')}E Perna Vagabundo, se apresentando. Você deve ser
${heroTermn} ${heroName}.
...
${yellow('<AmareloVagabundo>')}Vamos levantar essas camas senão não vai caber
todo mundo.
...
${yellow(
	'<NovinhaVagabundo ação=”cantar”>'
)}Nasceu tão lind${heroTermn}. Como ${heroA} anj${heroTermn}
...
${yellow('<PrincesinhaVagabundo>')}Ele não bate muito bem das ideia não.
Não liga pra ele.
${green('<' + heroName + '>')}Ele só me pediu água.
${yellow('<PrincesinhaVagabundo>')}É assim que começa, você dá água e vê onde
vai parar.
...
${cyan('<Lua>')}Não, obrigado, Filho. Eu não fumo, mas aceito uma panqueca
de brigadeiro branco com granulado colorido.
...
Fumam muito sangue. Riem alto e frequentemente estão
sacaneando um ao outro.
...
mais procurados do mundo pro meu barraco e você quer
que eu fique feliz, Lua?
...
${yellow('<Narração>')}O barraco é impecavelmente limpo em instantes
por Negão Vagabundo
