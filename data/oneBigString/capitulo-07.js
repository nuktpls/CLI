...
algumas panquecas. As panquecas são enfileiradas uma a uma, ${heroHe} despeja
...
dispensa e pega alguns ingredientes. El${heroTermn} volta com mais duas
pilhas de panquecas.
${green('<' + heroName + '>')}Aqui, pode comer maninho.
${yellow('<Narração>')}Constrangid${heroTermn}, el${heroTermn} começa a dar
voltas em círculo.
${yellow('<MenorVagabundo>')}Fala, ${heroName}. O que foi que tá
pegando?
${green('<' + heroName + '>')}É que faz uns dias aí, eu achei melhor não
...
${yellow('<Narração>')}Ao abrir a porta el${heroTermn} se depara
...
${yellow('<MenorVagabundo>')}Abriram as portas do asilo, foi? Você tá
acabadão desde a última vez que te vi. Mais velho, mais
amarelo.
${yellow('<AmareloVagabundo>')}E continuo sendo menos estúpido
que você né, pivete?
${yellow('<Narração>')}Olhares estranhos e tensos dão lugar a uma
grande gargalhada e comprimentos de mão.
${green('<' + heroName + '>')}Maninho, quem é esse dái? Tipo, é meio tarde eu
...
${green('<' + heroName + '>')}Mano, tô dizendo que é pra não chaviar o pé do
...
sabendo não.
${yellow('<MenorVagabundo>')}Nada, é aquela pirata lá dos heróis
sendo caçado por uns gringos.
${yellow('<AmareloVagabundo>')}Ah, sim. Sei qual é, achei que você
...
${green('<' + heroName + '>')}Vocês dois estão fazendo uma coisa errada e eu
não quero nenhum problema por aqui. Nenhum mesmo. A qualquer momento
pode chegar aqui um GADO.
...
Você deve ser ${heroTermn} ${heroName}.
${green('<' + heroName + '>')}Fala baixo, o que vocês estão fazendo aqui? Sai
daqui?
...
${green('<' + heroName + '>')}Qual foi dessa vez? Já lotou o suficiente aqui
...
${yellow('<Narração>')}Ao abrir a porta mais oito integrantes do
Esquadrão e Lua. Eles tocam um samba puxado pela voz da
Novinha Vagabundo.
${yellow('<NovinhaVagabundo ação=”cantar”>')}Nasceu tão lind${heroTermn}.
Como ${heroA} anj${heroTermn} veio sorrindo. Do céu aos meus braços veio
parar. Soluços e choros, mamadas e risadas, se fosse um
pouco maior eu iria te apertar. Filh${heroTermn} lind${heroTermn} o mundo
inteiro quer dizer, como eu crio você, mas não vou deixar não.
Já sei fazer você parar de chorar, sei sua cólica aliviar, pois
quem manda é o meu coração. ${heroName} querid${heroTermn}, se tu ouvires
...
${yellow('<BinárioVagabundo>')}A gente adora açúcar precioso, mas não mais gosto. De
repente se você me der o precioso, não quero. Deixa pra lá, pode me dar um
pouco de água?
...
Pede silêncio e insiste toda hora para que não comecem a cantar.
${green('<' + heroName + '>')}Eu vou ficar sem comida. As batatas não. Deixa
...
${cyan('<Lua>')}Não, obrigado, Filho. Eu não fumo, mas aceito uma
panqueca de brigadeiro branco com granulado colorido.
${yellow('<Narração>')}Lua sai do quarto e vai para a porta de entrada
e começa a contar.
${yellow('<Narração>')}Ela tropeça entre livros e bugigangas, parece
preocupada.
...
${yellow('<XMatematx para=”Lua”>')}Eu tô lendo o livro que você me
deu, Luazinha, mas eu não entendi nada o que o polvo tem a ver com a gente.
${cyan('<Lua>')}Um dia você entende, X.
${cyan('<Lua>')}Poxa, tem um Vagabundo a menos.
${yellow('<MenorVagabundo>')}Ele vai chegar atrasado. Ele teve que se
...
${yellow('<FilhoVagabundo>')}Lua, aqui a panqueca que você pediu
com brigadeiro branco. Eu achei um pouco enjoativa.
${cyan('<Lua>')}É perfeita!
${yellow('<FilhoVagabundo>')}Você é a única que gosta dessas coisas
doces por aqui.
...
${green('<' + heroName + '>')}Claro, eu não te vejo há anos, você chega e traz
...
${green('<' + heroName + '>')}Energia? Eu é que não tenho mais energia.
Eles acabaram com minha comida. Sujaram todo meu quarto. Tem
fumaça pra todo lado. Não vou nem falar o que vai acontecer
se os GADO chegarem aqui agora. Meu armazenador do
banheiro tá entupido! E eu nem gosto tanto assim da música deles.
${yellow('<Narração>')}Nesse momento o projetor é desligado e todos
ficam em silêncio. Olhares desconfiados direcionados para ${heroName}.
${green('<' + heroName + '>')}O que foi, eu tenho que gostar agora do que
vocês fazem?
